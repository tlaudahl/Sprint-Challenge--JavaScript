...
const universities = [];
graduates.forEach(e => universities.push(e.university));
...
const contactInfo = [];
graduates.forEach(e => contactInfo.push(`${e.first_name} ${e.email}`))
console.log(contactInfo);

/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called unisWithUni that contains them all. This will be an array of objects. Log the result. */
const unisWithUni = [];
graduates.forEach(e => e.university.includes('Uni') ? unisWithUni.push(e.university) : null)
